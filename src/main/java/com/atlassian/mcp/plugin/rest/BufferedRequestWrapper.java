 ...
 * it from an already-bounded byte[]; {@link SessionBindingFilter} uses the read-from-request
 * constructor to inspect {@code "method":"initialize"} before the SDK servlet reads the body
 * downstream.
 */
