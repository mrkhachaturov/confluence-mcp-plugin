        ...
        "properties",
            Map.of(
                ...
                Map.of(
                    ...
                    "string",
                    "description",
                    "The ID of the attachment to download (e.g., 'att123456789'). Find attachment IDs using get_attachments tool. Example workflow: get_attachments(content_id) → use returned ID here.")),
