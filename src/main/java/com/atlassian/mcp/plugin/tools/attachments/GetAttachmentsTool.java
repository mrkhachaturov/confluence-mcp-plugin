            ...
            Map.of(
                "content_id",
                    Map.of(
                        ...
                        "string",
                        "description",
                        "The ID of the Confluence content (page or blog post) to list attachments for. Example: '123456789'"),
                "start",
                    Map.of(
                        "type",
                        "integer",
                        "description",
                        "(Optional) Starting index for pagination. Use 0 for the first page. To get the next page, add the 'limit' value to 'start'. Default: 0",
                        "default",
                        0),
                "limit",
                    Map.of(
                        ...
                        "integer",
                        "description",
                        "(Optional) Maximum number of attachments to return per request (1-100). Use pagination (start/limit) for large attachment lists. Default: 50",
                        "default",
                        50),
                "filename",
                    Map.of(
                        ...
                        "string",
                        "description",
                        "(Optional) Filter results to only attachments matching this filename. Exact match only. Example: 'report.pdf'"),
                "media_type",
                    Map.of(
                        "type",
                        "string",
