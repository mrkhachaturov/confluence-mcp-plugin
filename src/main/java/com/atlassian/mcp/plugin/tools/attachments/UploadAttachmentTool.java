            ...
            Map.of(
                "content_id",
                    Map.of(
                        ...
                        "string",
                        "description",
                        "The ID of the Confluence content (page or blog post) to attach the file to. Page IDs can be found in the page URL or by using the search/get_page tools. Example: '123456789'"),
                "file_path",
                    Map.of(
                        "type",
                        "string",
                ...
                "comment",
                    Map.of(
                        ...
                        "string",
                        "description",
                        "(Optional) A comment describing this attachment or version. Visible in the attachment history. Example: 'Updated Q4 2024 figures'"),
                "minor_edit",
                    Map.of(
                        "type",
                        "boolean",
