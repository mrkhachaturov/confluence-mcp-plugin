...
public class AppendToPageTool implements McpTool {
    ...
    return Map.of(
        ...
        "properties",
            Map.of(
                "page_id",
                    Map.of(
                        "type", "string", "description", "The ID of the page to append content to"),
                "content",
                    Map.of(
                        "type",
                        "string",
                        "description",
                        "Content to append (in Markdown by default). Added after the existing page content."),
                "content_format",
                    Map.of(
                        "type",
                        "string",
                        "description",
                        "(Optional) Format of the content: 'markdown' (default), 'wiki', or 'storage'.",
                        "default",
                        "markdown"),
                "expected_version",
                    Map.of(
                        ...
                        "integer",
                        "description",
                        "If provided, the update will fail if the page's current version doesn't match. Prevents overwriting concurrent changes.")),
  ...
  public String execute(Map<String, Object> args, String authHeader) throws McpToolException {
    ...
    requestBody.put(
        "body", Map.of("storage", Map.of("value", combinedBody, "representation", "storage")));
