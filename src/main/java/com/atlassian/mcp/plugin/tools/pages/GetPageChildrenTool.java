            ...
            Map.of(
                ...
                "expand",
                    Map.of(
                        ...
                        "string",
                        "description",
                        "Fields to expand in the response (e.g., 'version', 'body.storage')",
                        "default",
                        "version"),
                "limit",
                    Map.of(
                        ...
                        "integer",
                        "description",
                        "Maximum number of child items to return (1-50)",
                        "default",
                        25),
                "include_content",
                    Map.of(
                ...
                "include_folders",
                    Map.of(
                        ...
                        "boolean",
                        "description",
                        "Whether to include child folders in addition to child pages",
                        "default",
                        true)),
