...
public class GetPageTool implements McpTool {
            ...
            Map.of(
                ...
                "include_metadata",
                    Map.of(
                        ...
                        "boolean",
                        "description",
                        "Whether to include page metadata such as creation date, last update, version, and labels.",
                        "default",
                        true),
                "convert_to_markdown",
                    Map.of(
  ...
  public String execute(Map<String, Object> args, String authHeader) throws McpToolException {
    ...
    if (pageId != null && !pageId.isBlank()) {
      ...
      rawJson =
          client.getRaw("/rest/api/content/" + pageId + "?expand=" + encode(expand), authHeader);
      ...
      if (root.has("results")) {
        ...
        if (!results.isArray() || results.size() == 0) {
          throw new McpToolException(
              "Page not found with title '" + title + "' in space '" + spaceKey + "'");
        }
        pageNode = results.get(0);
      }

      ObjectNode simplified =
          ResponseTransformer.simplifyPageNode(pageNode, baseUrl, convertToMarkdown);
