...
/** Mirrors upstream: confluence_mcp.move_page() Returns: {message, page: {simplified page dict}} */
            ...
            Map.of(
                ...
                "target_parent_id",
                    Map.of(
                        ...
                        "string",
                        "description",
                        "Target parent page ID. If omitted with target_space_key, moves to space root."),
                "target_space_key",
                    Map.of(
                        "type", "string", "description", "Target space key for cross-space moves"),
                "position",
                    Map.of(
                        "type",
                        "string",
                        "description",
                        "Position: 'append' (default, move as child of target), 'above' (move before target as sibling), or 'below' (move after target as sibling)",
                        "default",
                        "append")),
