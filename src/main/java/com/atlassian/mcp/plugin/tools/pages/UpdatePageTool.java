    ...
    return Map.of(
        ...
        "properties",
            Map.ofEntries(
                Map.entry(
                    "page_id",
                    Map.of("type", "string", "description", "The ID of the page to update")),
                Map.entry(
                ...
                Map.entry(
                    ...
                    Map.of(
                        ...
                        "string",
                        "description",
                        "The new page content in Markdown. All rich features (panels, status badges, tasks, TOC, expand) work in Markdown — see tool description. Do NOT start with '# Title'.")),
                Map.entry(
                    "is_minor_edit",
                    Map.of(
                        "type",
                ...
                Map.entry(
                    "version_comment",
                    Map.of("type", "string", "description", "Optional comment for this version")),
                Map.entry(
                    "parent_id",
                    Map.of("type", "string", "description", "Optional the new parent page ID")),
                Map.entry(
                    "content_format",
                    Map.of(
                        "type",
                        "string",
                        "description",
                        "(Optional) The format of the content parameter. Options: 'markdown' (default), 'wiki', or 'storage'.",
                        "default",
                        "markdown")),
                Map.entry(
                    "emoji",
                ...
                Map.entry(
                    ...
                    Map.of(
                        ...
                        "integer",
                        "description",
                        "If provided, the update will fail if the page's current version doesn't match this value. Use the version number from get_page to prevent overwriting concurrent changes.")),
                Map.entry(
                    "return_markdown",
                    Map.of(
                        "type",
