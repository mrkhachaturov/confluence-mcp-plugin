...
/**
 * Unit tests for the SSRF-hardening checks on the {@code confluenceBaseUrl} override.
 * All cases use literal IPs/hosts so no real DNS lookup is required (numeric literals are parsed
 * by {@code InetAddress.getAllByName} without a network round-trip).
 */
