...
public class RateLimiterTest {
  ...
  public void keysAreIndependent_noGlobalClear() {
    ...
    assertTrue(
        "a different key must have its own independent window", rl.isAllowed("ip2", "mcp", 5));
  }
  ...
  public void endpointsAreIndependent() {
    ...
    assertFalse(rl.isAllowed("ip1", "mcp", 5));
    assertTrue(
        "same ip, different endpoint is a different bucket", rl.isAllowed("ip1", "register", 5));
  }
